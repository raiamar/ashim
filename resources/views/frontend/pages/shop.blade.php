...
@section('content')
    ...
    <div class="menu-banner page-banner">
        ...
        <div class="menu-banner-content">
            <div class="container">
                {{-- <h3 class="text-white text-uppercase text-center"> <img src="{{asset('uploads/avatar/'. $user->image)}}"> </h3> --}}
                <h1 class="text-white text-center mb-4">{{$user->name}}</h1>
            </div>
        </div>
    </div>
    ...
    <div class="form-header margin-auto mb-5">
...
@stop
<style>
    .what-a{text-decoration: none; color: black}
    .what-a:hover{text-decoration: none; color: black}
    .stars {
        width: fit-content;
        margin: 0 auto;
        cursor: pointer;
