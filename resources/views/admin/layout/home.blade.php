...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info" style="margin:auto">
          <a href="#" class="d-block" style="text-align: center; text-decoration: none;"><h4>{{Auth::user()->name}}</h4></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('index.product')}}" class="nav-link"><i class="nav-icon fas fa-th"></i><p>Add Products</p></a>
          </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            @if(Auth::user()->role == "admin")
              <td class="d-flex">
                <form action="{{route('change.role', $data->id)}}" method="GET">
                  ...
                  <button class="btn btn-primary ml-2" onclick="javascript:this.form.submit();">Change Role</button>
                </form>

                <a href="{{route('remove.user', $data->id)}}" class="btn btn-danger ml-2"> <i class="fa fa-trash"></i> </a>
              </td>
            @else
            <td> <p style="text-align: center; color:red">Permission Denied</p> </td> 
            @endif
      ...
      <style>
        .dashboard{background: red; padding: 10px; margin: 3px; border-radius: 3px;}
        .d-cont h4, p{
          color: white;
          text-align: center;
        }
